function searchWord(word, text) {
  return text
    .toLowerCase()
    .split(" ")
    .map((target) => (target === word ? `**${target.toUpperCase()}**` : target))
    .join(" ");
}
...
//    ea commodi consequatur? **SED** quis autem vel est, iure reprehenderit
//    qui in ea voluptate velit esse quam nihil molestiae consequatur. Ut
